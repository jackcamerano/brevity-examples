...
- "This *usually* works" → drop "usually" and a hedge becomes a guarantee. Keep.
- "Supported *on Postgres 14+*" → drop the scope and the claim overreaches. Keep.
- "It returned *3* errors" → the number is the content. Keep.
